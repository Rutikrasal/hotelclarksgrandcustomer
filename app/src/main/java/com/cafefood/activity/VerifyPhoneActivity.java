...
import com.cafefood.model.LoginUser;
...
import com.cafefood.utils.Utiles;
...
import static com.cafefood.utils.Utiles.isvarification;
...
public class VerifyPhoneActivity extends AppCompatActivity implements GetResult.MyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Log.d("BTAG","COUNTRY CODE IS..."+phonecode);
        phone = "+91"+phonenumber;
        Log.d("BTAG","PHONE NO IS ..."+phone);
        sendVerificationCode(phone);
        txtMob.setText("We have sent you an SMS on " + phone + "\n with 6 digit verification code");
        try {
