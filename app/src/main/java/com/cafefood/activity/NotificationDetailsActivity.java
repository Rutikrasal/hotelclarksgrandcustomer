...
import com.cafefood.model.Noti;
import com.cafefood.model.ReadNoti;
...
public class NotificationDetailsActivity extends AppCompatActivity implements GetResult.MyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).asBitmap().load(APIClient.baseUrl + noti.getImg()).placeholder(R.drawable.logoamigo).into(imgNoti);
